...
},{"./gsap-core.js":"../node_modules/gsap/gsap-core.js","./CSSPlugin.js":"../node_modules/gsap/CSSPlugin.js"}],"js/bangalore-plans.js":[function(require,module,exports) {
"use strict";

var _gsap = require("gsap");
// Fade-in animation for the question and images
var init = function init() {
  _gsap.gsap.fromTo('.content__title', {
    opacity: 0,
    y: 50
  }, {
    opacity: 1,
  ...
  _gsap.gsap.fromTo('.question__item', {
    opacity: 0,
    scale: 0.7
  }, {
    opacity: 1,
  ...
  // Attach click listeners for a slide transition to the next question
  document.querySelectorAll('.question__item').forEach(function (item, index) {
    item.addEventListener('click', function () {
      slideToNextQuestion(index);
    });
  });
};

// Slide transition to next question
var slideToNextQuestion = function slideToNextQuestion(index) {
  _gsap.gsap.to('.content', {
    ...
    onComplete: function onComplete() {
      window.location.href = "nextQuestion.html?selection=".concat(index);
    }
  });
};
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/bangalore-plans.js"], null)
//# sourceMappingURL=/bangalore-plans.951a7da5.js.map